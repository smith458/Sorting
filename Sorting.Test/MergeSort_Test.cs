...
namespace Sorting.Test
{
    ...
    public class MergeSort_Test
    {
        ...
        public void MergeEmptyTest()
        {
            ...
            Assert.AreEqual(finish, Merge<int>.Sort(start));
        }

        [Test]
        public void mergeZeroTest()
        {
            int[] start = new int[] { 0 };
            int[] finish = new int[] { 0 };
            Assert.AreEqual(finish, Merge<int>.Sort(start));
        ...
        [Test]
        public void MergeBiggestLeftTest()
        {
        ...
        public void MergeStringTest()
        {
            ...
            Assert.AreEqual(finish, Merge<string>.Sort(start));
        }
